...
public class SPConstants {
	...
	public static String SP_EVENTS_WSURL = "ws://app3.atomiton.com:8090/fid-sensors";
	
	public static String SERVER_URL = "http://app3.atomiton.com:8080/fid-smartparking";
	
	public static String SP_ORG_PARAMS = "Command=readAll&Model=Organization";
	
	public static String SNAPSHOT_URL = "http://app3.atomiton.com:8080/fid-ParkingResoures/res/";
	
	public static String ACTIONS_URL = "http://app3.atomiton.com:8080/fid-actions";
